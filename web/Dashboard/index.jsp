...
<head>
  ...
  <meta content="" name="keywords">/media/kigaliwe-code/1d41f6a9-5b8e-435d-a2b6-f116abe8919b/yves/Java web programing backup/EmployeeManagementSystem/src/main/webapp/WEB-INF/lib/mysql-connector-java-8.0.27.jar
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Welcome to Smart Appealing</p>
            </div>
          </div>
