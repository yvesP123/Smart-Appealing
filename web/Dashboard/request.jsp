    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Requesting  Form</h5>

              <!-- General Form Elements -->
              <form method="post" action="../requestupload" enctype="multipart/form-data" >
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">RegNumber</label>
                  <div class="col-sm-10">
                    <input type="text" name="regnumber" value="${username }" class="form-control" readonly>
                  </div>
                </div>
...
<%} %>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="phone" class="form-control" placeholder="Please enter the phone number used to pay">
                    </div>
                  </div>
