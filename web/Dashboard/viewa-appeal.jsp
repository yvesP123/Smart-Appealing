    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <a  class="nav-link" href="add_lect.jsp">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="nav-link " href="add_course.jsp" >
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">list of all student's pedding appealingss</h5>
...
<%
Statement st=null;
String sql="select * from appeal,courses,lecturer_tbl WHERE appeal.course_id=courses.course_id AND appeal.lect_id=lecturer_tbl.lect_id AND appeal.status='Approved' OR appeal.status='Denied'";
...
<%
String app=rs.getString("status");
if(app=="Denied")
{
%>
 <td><a href='approve.jsp?id=<%=rs.getInt("app_id") %>' class="btn btn-primary">Approve</a></td>
 
 <%}
else
{
%>
 <td><a href='deny.jsp?id=<%=rs.getInt("app_id") %>' class="btn btn-danger">Deny</a></td>
<%} %>
</tr>
<%} %>
