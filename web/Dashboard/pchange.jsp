  ...
  <!-- ======= Sidebar ======= -->
          <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="password-change.jsp" novalidate>

                    <div class="col-2">
                      <label for="yourUsername" class="form-label">Enter the new password</label>
                      <div class="input-group has-validation">
                      
                        <input type="text" name="pass" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-2">
                      ...
                      <input type="text" name="pass" class="form-control" id="yourPassword" required>
