...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>View Request To Remark</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">View</li>
          <li class="breadcrumb-item active">Request To Remark</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">list of all student need to Remark</h5>
...
String sql="select * from remarks,courses,lecturer_tbl WHERE remarks.course_id=courses.course_id AND remarks.lect_id=lecturer_tbl.lect_id AND remarks.status='Approved' AND lecturer_tbl.lect_name='$users'";
...
<td><%=rs.getInt("remark_id") %></td>
<td><%=rs.getString("regnumber") %></td>
<td><%=rs.getString("course_name") %></td>
<td><%=rs.getString("code") %></td>
<td><%=rs.getString("lect_name") %></td>
<td><a href="<%Blob blob=rs.getBlob("reason"); %>" tagert="blank"><%=rs.getBlob("reason") %></a></td>
