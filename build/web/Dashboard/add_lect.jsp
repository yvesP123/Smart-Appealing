        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="addlect.jsp">
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">lecture name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="lname" placeholder="enter lecture name">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="text" name="phone" id="formFile">
                  </div>
                </div>
                <div class="row mb-3">
