...
<%
Statement st=null;
String sql="select * from appeal,courses,lecturer_tbl WHERE appeal.course_id=courses.course_id AND appeal.lect_id=lecturer_tbl.lect_id AND appeal.status='pending'";
