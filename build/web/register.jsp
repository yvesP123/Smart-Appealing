            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidateac method="post" action="register-process.jsp">
                    <div class="col-12">
                      <label for="yourName" class="form-label">Your Names</label>
                      <input type="text" name="names1" class="form-control" id="yourName" required>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <div class="invalid-feedback">Student you have to agree before submitting.</div>
                      </div>
                    </div>
                    <div class="col-12">
